...
WARNING: This mechanism is very slow with a small sample period. Hence it is not
useful at the time (until we figure out the cause). Please use lfp_sumstep.mod
isntead.
